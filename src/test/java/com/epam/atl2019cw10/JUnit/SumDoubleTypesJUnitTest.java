...
public class SumDoubleTypesJUnitTest {
    ...
    public SumDoubleTypesJUnitTest(double firstValue, double secondValue) {
        this.firstValue = firstValue;
        this.secondValue = secondValue;
    }

    @Test
    public void sumDoubleTypesJUnitTest() {
        Assert.assertEquals((firstValue+secondValue),calculator.sum(firstValue,secondValue),0D);
    }
