...
public class PowDoubleTypesJUnitTest {
    ...
    public PowDoubleTypesJUnitTest(double firstValue, double secondValue) {
    ...
    @Test
    public void powDoubleTypesJUnitTest() {
        Assert.assertEquals((Math.pow(firstValue,secondValue)),calculator.pow(firstValue,secondValue),0D);
    }
