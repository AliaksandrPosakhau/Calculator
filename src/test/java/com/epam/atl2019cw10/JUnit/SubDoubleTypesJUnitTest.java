...
public class SubDoubleTypesJUnitTest {
    ...
    public SubDoubleTypesJUnitTest(double firstValue, double secondValue) {
        this.firstValue = firstValue;
        this.secondValue = secondValue;
    }

    @Test
    public void subDoubleTypesJUnitTest() {
        Assert.assertEquals((firstValue-secondValue),calculator.sub(firstValue,secondValue),0D);
    }
